...
<x-organizer-layout>
    ...
    <div class="p-10 max-w-7xl mx-auto">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            @endif
            <form method="POST" action="{{ route('organizer.event.tickets.update', ['event' => $event->id, 'ticket' => $ticket->id]) }}">
                @csrf
                ...
                <div class="px-6 py-4">
                    ...
                    <x-text-input id="price" class="block mt-1 w-full" type="text" name="price" value="{{ $ticket->price }}" required autofocus />
