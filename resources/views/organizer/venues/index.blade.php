        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Land</th>
                        <th scope="col" class="px-6 py-3">
                            <x-primary-button-link size="sm" href="{{ route('organizer.venues.create') }}" class="w-full flex justify-center items-center">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex flex-row justify-between">
                                    <a href="{{route('organizer.venues.show', $venue)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    ...
                                    <a href="{{route('organizer.venues.edit', $venue)}}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6 h-4">
                                            <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
